import { translateText } from '@/helper/utils'
...
export const techStack = [
  ...
  },
  {
    ...
    color: 'cyan',
    skills: ['Jest', 'React Testing Library', 'openapi-typescript', 'Vite', 'Webpack', 'Git', 'Jira', 'Agile / Scrum']
  },
  {
